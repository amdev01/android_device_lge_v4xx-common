...
# Audio configuration
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/configs/audio_policy.conf:system/system/vendor/etc/audio_policy.conf \
    $(LOCAL_PATH)/configs/mixer_paths.xml:system/system/vendor/etc/mixer_paths.xml
...
# Seccomp
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/configs/mediacodec.policy:system/system/vendor/etc/seccomp_policy/mediacodec.policy \
    $(LOCAL_PATH)/configs/mediaextractor.policy:system/system/vendor/etc/seccomp_policy/mediaextractor.policy
